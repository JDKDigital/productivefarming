...
public class CropMutationRecipe implements Recipe<RecipeInput>
{
    ...
    public CropMutationRecipe(ResourceLocation targetCrop, ResourceLocation pollenCrop, ResourceLocation mutation, float chance) {
