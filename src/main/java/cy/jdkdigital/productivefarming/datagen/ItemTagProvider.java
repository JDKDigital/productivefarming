...
//        tag(ModTags.Items.CRAB_FOOD)
        ...
        addMysticalTier(ModTags.Items.MYSTICAL_TIER_2, "aluminum_seeds", "amethyst_seeds", "apatite_seeds", "armadillo_seeds", "basalt_seeds", "chicken_seeds", "coal_seeds", "coral_seeds", "cow_seeds", "dye_seeds", "fish_seeds", "grains_of_infinity_seeds", "honey_seeds", "kivi_seeds", "limestone_seeds", "marble_seeds", "menril_seeds", "mystical_flower_seeds", "nature_seeds", "nether_seeds", "pig_seeds", "rubber_seeds", "saltpeter_seeds", "sheep_seeds", "silicon_seeds", "slime_seeds", "squid_seeds", "sulfur_seeds", "turtle_seeds", "unexplored_wood_seeds");
        addMysticalTier(ModTags.Items.MYSTICAL_TIER_3, "amethyst_bronze_seeds", "aquamarine_seeds", "azure_silver_seeds", "basalz_seeds", "black_quartz_seeds", "blitz_seeds", "blizz_seeds", "brass_seeds", "bronze_seeds", "certus_quartz_seeds", "conductive_alloy_seeds", "copper_alloy_seeds", "copper_seeds", "creeper_seeds", "crimson_iron_seeds", "darkstone_seeds", "glowstone_seeds", "graphite_seeds", "iron_seeds", "ironwood_seeds", "lead_seeds", "manasteel_seeds", "nether_quartz_seeds", "obsidian_seeds", "phantom_seeds", "pig_iron_seeds", "prismarine_seeds", "quartz_enriched_iron_seeds", "rabbit_seeds", "redstone_alloy_seeds", "redstone_seeds", "sculk_seeds", "silver_seeds", "skeleton_seeds", "sky_stone_seeds", "slimesteel_seeds", "spider_seeds", "steeleaf_seeds", "tin_seeds", "xychorium_gem_seeds", "zinc_seeds", "zombie_seeds");
        ...
        addMysticalTier(ModTags.Items.MYSTICAL_TIER_5, "cyanite_seeds", "diamond_seeds", "draconium_seeds", "emerald_seeds", "end_steel_seeds", "enderium_seeds", "entro_seeds", "flux_infused_gem_seeds", "hepatizon_seeds", "iridium_seeds", "manyullyn_seeds", "netherite_seeds", "niotic_crystal_seeds", "platinum_seeds", "queens_slime_seeds", "rock_crystal_seeds", "sky_steel_seeds", "spirited_crystal_seeds", "terrasteel_seeds", "uraninite_seeds", "vibrant_alloy_seeds", "wither_skeleton_seeds", "yellorium_seeds");
        addMysticalTier(ModTags.Items.MYSTICAL_TIER_6, "allthemodium_seeds", "awakened_draconium_seeds", "dragon_egg_seeds", "gaia_spirit_seeds", "nether_star_seeds", "neutronium_seeds", "nitro_crystal_seeds", "unobtainium_seeds", "vibranium_seeds");
