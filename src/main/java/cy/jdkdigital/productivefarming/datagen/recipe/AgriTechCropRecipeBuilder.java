...
public record AgriTechCropRecipeBuilder(Identifier id, Ingredient seed, List<Ingredient> soils, List<CropDropSpec> drops) implements RecipeBuilder
{
    public static AgriTechCropRecipeBuilder crop(Identifier id, Ingredient seed, List<Ingredient> soils, List<CropDropSpec> drops) {
        return new AgriTechCropRecipeBuilder(id, seed, soils, drops);
    }
