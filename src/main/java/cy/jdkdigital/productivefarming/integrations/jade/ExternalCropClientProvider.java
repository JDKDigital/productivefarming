...
public class ExternalCropClientProvider implements IBlockComponentProvider
{
    public static final ExternalCropClientProvider INSTANCE = new ExternalCropClientProvider();

    @Override
    public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig config) {
        CropServerProvider.Data data = ExternalCropServerProvider.INSTANCE.decodeFromData(accessor).orElse(null);
    ...
    public Identifier getUid() {
        return ExternalCropServerProvider.UID;
    }
}
