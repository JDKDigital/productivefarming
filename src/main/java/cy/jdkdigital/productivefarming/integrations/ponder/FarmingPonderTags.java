...
{
    public static final ResourceLocation FARM_CONTROLLER_BLOCKS = ResourceLocation.fromNamespaceAndPath(ProductiveFarming.MODID, "farm_controller_blocks");
    public static final ResourceLocation FARM_BUILDING_BLOCKS = ResourceLocation.fromNamespaceAndPath(ProductiveFarming.MODID, "farm_building_blocks");
    public static final ResourceLocation FARM_FARMLAND = ResourceLocation.fromNamespaceAndPath(ProductiveFarming.MODID, "farm_farmland");
